...
class Musician {
  ...
  constructor(name, instrument) {
    ...
    Musician.count = Musician.count + 1;
...
Object.defineProperty(Musician.prototype, "band", {
  ...
  enumerable: true, // Дозволяє властивість бути перерахованою
  configurable: true, // Дозволяє переналаштовувати властивість
});
...
class Band {
  ...
  constructor(name, members) {
    this.#name = name;
    this.#members = members.filter((member) => member instanceof Musician);
  }
  get name() {
    return this.#name;
  }
